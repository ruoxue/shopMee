...
public class ProductBannerController extends BaseController
{
     ...
     * 查询banner列表
     */
    @RequiresPermissions("shop:productBanner:list")
    @GetMapping("/list")
     ...
     * 导出banner列表
     */
    @RequiresPermissions("shop:productBanner:export")
     ...
     * 获取banner详细信息
     */
    @RequiresPermissions("shop:productBanner:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增banner
     */
    @RequiresPermissions("shop:productBanner:add")
     ...
     * 修改banner
     */
    @RequiresPermissions("shop:productBanner:edit")
     ...
     * 删除banner
     */
    @RequiresPermissions("shop:productBanner:remove")
