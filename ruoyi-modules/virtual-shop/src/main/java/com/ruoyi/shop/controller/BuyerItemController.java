...
public class BuyerItemController extends BaseController
{
     ...
     * 查询购买明细列表
     */
    @RequiresPermissions("shop:buyerItem:list")
    @GetMapping("/list")
     ...
     * 导出购买明细列表
     */
    @RequiresPermissions("shop:buyerItem:export")
     ...
     * 获取购买明细详细信息
     */
    @RequiresPermissions("shop:buyerItem:query")
     ...
     * 新增购买明细
     */
    @RequiresPermissions("shop:buyerItem:add")
     ...
     * 修改购买明细
     */
    @RequiresPermissions("shop:buyerItem:edit")
     ...
     * 删除购买明细
     */
    @RequiresPermissions("shop:buyerItem:remove")
