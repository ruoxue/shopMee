...
import com.ruoyi.mobile.service.IBuyerItemService;
...
public class BuyerItemController extends BaseController
{
     ...
     * 查询购买明细列表
     */
    @RequiresPermissions("mobile:buyerItem:list")
    @GetMapping("/list")
     ...
     * 导出购买明细列表
     */
    @RequiresPermissions("mobile:buyerItem:export")
     ...
     * 获取购买明细详细信息
     */
    @RequiresPermissions("mobile:buyerItem:query")
     ...
     * 新增购买明细
     */
    @RequiresPermissions("mobile:buyerItem:add")
     ...
     * 修改购买明细
     */
    @RequiresPermissions("mobile:buyerItem:edit")
     ...
     * 删除购买明细
     */
    @RequiresPermissions("mobile:buyerItem:remove")
