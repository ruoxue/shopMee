...
import com.ruoyi.mobile.service.IBuyerPaymentService;
...
public class BuyerPaymentController extends BaseController
{
     ...
     * 查询支付列表
     */
    @RequiresPermissions("mobile:buyerPayment:list")
    @GetMapping("/list")
     ...
     * 导出支付列表
     */
    @RequiresPermissions("mobile:buyerPayment:export")
     ...
     * 获取支付详细信息
     */
    @RequiresPermissions("mobile:buyerPayment:query")
     ...
     * 新增支付
     */
    @RequiresPermissions("mobile:buyerPayment:add")
     ...
     * 修改支付
     */
    @RequiresPermissions("mobile:buyerPayment:edit")
     ...
     * 删除支付
     */
    @RequiresPermissions("mobile:buyerPayment:remove")
