...
public class BuyerCartController extends BaseController
{
     ...
     * 查询购物车列表
     */
    @RequiresPermissions("mobile:buyerCart:list")
    @GetMapping("/list")
     ...
     * 导出购物车列表
     */
    @RequiresPermissions("mobile:buyerCart:export")
     ...
     * 获取购物车详细信息
     */
    @RequiresPermissions("mobile:buyerCart:query")
     ...
     * 新增购物车
     */
    @RequiresPermissions("mobile:buyerCart:add")
     ...
     * 修改购物车
     */
    @RequiresPermissions("mobile:buyerCart:edit")
     ...
     * 删除购物车
     */
    @RequiresPermissions("mobile:buyerCart:remove")
